...
// якою варто скористатись є особливіть використання
...
// і надані кожного шматочка пам’яті у володіння лише 1ій
// горутині.
...
// єдиній горутині. Це гарантуватие що дані ніколи не будуть
