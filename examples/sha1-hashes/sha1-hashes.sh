# Запуск цієї программи порахуує хеш та виведе його у
...
# хеші - порівняйте про [різноматнітні алгоритми шифрування,
# їх переваги і недоліки](https://uk.wikipedia.org/wiki/Криптографічна_хеш-функція)!
