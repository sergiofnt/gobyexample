// [хешування _SHA1_](https://uk.wikipedia.org/wiki/SHA-1)
// використовують для визначення коротких ідентифікаторів
// для двійкових або текстових даних. Наприклад,
// [система контролю версій git](http://git-scm.com/)
// використовує SHA1 для ідентифікації змін файлів та директорій.
// В Go визначити SHA1 хеш можна наступним чином.

package main

// Go реалізує кілька різноманітних алгоритмів хешування,
// вони доступні нам як пакети `crypto/*`.
import "crypto/sha1"
import "fmt"
...
func main() {
    ...
    // Аргумент ( що передається `Sum`) може бути використано,
