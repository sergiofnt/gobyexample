...
func main() {
    ...
    // Ось базовий приклад, де ми бичимо - що нам не потрібні
    // круглі дужки навколо умови в Go, хоча потреба фігурні
    // дужки нікуди не зникла.
    if 7%2 == 0 {
        fmt.Println("7 парне")
    } else {
    ...
    // Ми можемо декларувати зміні які будуть доступні у
    // всьому розгалуженні (не тільки `if`, але і у `else if`
    // та `else`).
    if num := 9; num < 0 {
