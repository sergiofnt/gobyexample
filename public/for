...
<html>
  <head>
    <meta charset="utf-8">
    <title>Go за Прикладом: Цикл For</title>
  ...
  <body>
    <div class="example" id="for">
      ...
      <table>
        ...
        <tr>
          <td class="docs">
            <p><code>for</code> це єдина конструкція циклу в Go. Нижче наведено
три базові типи для циклів <code>for</code>.</p>
        ...
        <tr>
          <td class="docs">
            <p>Найбільш базовий тип, з єдиною інструкцією.</p>
    ...
    <span class="p">}</span>
        ...
        <tr>
          <td class="docs">
            <p>Класичний ініціалізація/умова/післяумова <code>for</code> цикл,
також відомий як С-style <code>for</code> цикл.</p>
    ...
    <span class="p">}</span>
        ...
        <tr>
          <td class="docs">
            <p><code>for</code> без умови буде видбуватись постійно
...
<code>return</code> (що повертає значення з заключаючої функції).</p>
    ...
    <span class="p">}</span>
        ...
        <tr>
          <td class="docs">
            <p>Ви також можете використати ключове слово <code>continue</code>
для переходу до наступної ітерації циклу.</p>
...
<span class="go">5</span>
        ...
        <tr>
          <td class="docs">
            <p>Ми ще побачимо інші форми <code>for</code> пізніше
коли ми будемо працювати з твердженями <code>range</code>,
каналами та іншими структурами данних.</p>
      ...
      <p class="next">
        Наступний приклад: <a href="if-else">Розгалуження Умови - Якщо/Інакше (If/Else)</a>.
      </p>
      
	  <p class="footer">
        Автор <a href="https://twitter.com/mmcgrana">@mmcgrana</a> | Переклад <a href="https://twitter.com/butuzov">@butuzov</a> | <a href="mailto:butuzov@made.ua">відгуки</a> | <a href="https://github.com/butuzov/gobyexample/blob/ukrainian/examples/for">source</a> | <a href="https://github.com/butuzov/gobyexample#license">ліцензія</a>
      </p>
    </div>
  </body>
</html>
